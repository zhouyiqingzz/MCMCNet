...
def inference_result():
    ...
    model_path='/home/arsc/tmp/pycharm_project_698/DA_Road/run_model_experiments/our_model/CHN6/experiment_20240407_012836/175_checkpoint.pth'#修改(2)
    ...
    out_path = '../test_output/CHN6/OurModel/' + out_id #修改(3)
    if not os.path.exists(out_path):
        try:
            os.mkdir(out_path)
        except FileExistsError:
            pass
    base_dir='/home/arsc/tmp/pycharm_project_639/CSA/data/CHN6/val'
    test_imgnames=os.listdir(os.path.join(base_dir,'images'))
    #加载测试集并测试
    count=0
    for i, imgname in enumerate(test_imgnames):
        count+=1
        imgname=imgname.strip()
        img_path=os.path.join(base_dir+'/images',imgname)
        label_path=os.path.join(base_dir+'/gt',imgname.split('_')[0]+'_mask.png')
        skeleton_path = os.path.join(base_dir + '/skeleton', imgname.split('_')[0]+'_mask.png')
